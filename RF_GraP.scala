...
object RF_GraP {
  ...
  def main(args: Array[String]) {
    val sc = new SparkContext(args(0), "RF_GraP", System.getenv("SPARK_HOME"))
    ...
    //println("RF_GraP, number of key-based rules is: " + key_based.length)
    ...
    println("RF_GraP, number of correlated rules is: " + final_AC.count())
